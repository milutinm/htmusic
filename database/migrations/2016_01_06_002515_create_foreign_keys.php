...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		Schema::table('artists', function(Blueprint $table) {
			$table->foreign('type_id')->references('id')->on('artist_types')
						->onDelete('cascade')
						->onUpdate('cascade');
		});
		...
		Schema::table('artist_aliases', function(Blueprint $table) {
			$table->foreign('type_id')->references('id')->on('artist_alias_types')
						->onDelete('cascade')
						->onUpdate('cascade');
		});
		...
		Schema::table('artist_credit_name', function(Blueprint $table) {
			$table->foreign('artist_credit')->references('id')->on('artist_credit')
						->onDelete('restrict')
						->onUpdate('restrict');
		});
		Schema::table('artist_credit_name', function(Blueprint $table) {
	...
	public function down()
	{
		...
		Schema::table('artist_aliases', function(Blueprint $table) {
			$table->dropForeign('artist_aliases_type_id_foreign');
		});
		Schema::table('releases', function(Blueprint $table) {
		...
		Schema::table('artist_credit_name', function(Blueprint $table) {
			$table->dropForeign('artist_credit_name_artist_credit_foreign');
		});
		Schema::table('artist_credit_name', function(Blueprint $table) {

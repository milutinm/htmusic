			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group @if ($errors->has('source')) has-error @endif ">
						{!! Form::label('source', trans('htmusic.source').':', ['class' => 'col-md-2 control-label']) !!}
						<div class="col-md-10">
							{!! Form::url('source', $image->source, ['class' => 'form-control']) !!}
						</div>
						@if ($errors->has('source')) <div class="col-md-offset-2 col-md-10 help-block">{{ $errors->first('source') }}</div> @endif
					</div>
					<div class="form-group @if ($errors->has('file')) has-error @endif ">
						{!! Form::label('file', trans('htmusic.file').':', ['class' => 'col-md-2 control-label']) !!}
						<div class="col-md-10">
							{!! Form::file('file', '', ['class' => 'form-control', 'required' => 'required']) !!}
						</div>
						@if ($errors->has('file')) <div class="col-md-offset-2 col-md-10 help-block">{{ $errors->first('file') }}</div> @endif
					</div>
					<div class="form-group @if ($errors->has('caption')) has-error @endif ">
						...
						<div class="col-md-10">
							{!! Form::text('caption', $image->caption, ['class' => 'form-control', 'required' => 'required']) !!}
						</div>
